...
export default function ProcessSelector({ array, group }) {
    ...
    if (group !== 0) {
        ...
        if (isPreviousDialogueReset()) { // Was the last script a non-selection?
            // wait
            ...
            /**
             * previousDialogue[0][0] contains the script which should be rendered according to the rules.
