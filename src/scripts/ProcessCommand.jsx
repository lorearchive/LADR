              ...
              return (
                <span className="emsvg">
                  <svg
                    ...
                    height="16"
                    fill="currentColor"
                    className="bi bi-droplet size-5"
                    viewBox="0 0 16 16"
                  >
                    <path
                      fillRule="evenodd"
            ...
            case "[빠직]":
              return (
                <span className="emsvg">
                  ...
                  >
                    <path
                      d="M50 20 C20 20, 15 0, 15 0 C14 -2, 16 -3, 18 -2 C20 -1, 35 15, 50 15 C65 15, 80 -1, 82 -2 C84 -3, 86 -2, 85 0 C85 0, 80 20, 50 20Z"
                      fill="white"
                    />

                    <path
                      d="M50 80 C20 80, 15 100, 15 100 C14 102, 16 103, 18 102 C20 101, 35 85, 50 85 C65 85, 80 101, 82 102 C84 103, 86 102, 85 100 C85 100, 80 80, 50 80Z"
                      fill="white"
                    />

                    <path
                      d="M20 50 C20 20, 0 15, 0 15 C-2 14, -3 16, -2 18 C-1 20, 15 35, 15 50 C15 65, -1 80, -2 82 C-3 84, -2 86, 0 85 C0 85, 20 80, 20 50Z"
                      fill="white"
                    />

                    <path
                      d="M80 50 C80 20, 100 15, 100 15 C102 14, 103 16, 102 18 C101 20, 85 35, 85 50 C85 65, 101 80, 102 82 C103 84, 102 86, 100 85 C100 85, 80 80, 80 50Z"
                      fill="white"
                    />
                  </svg>
                </span>
