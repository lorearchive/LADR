    ...
    switch(type) {
        ...
        case "center":
            output = (
                ...
                <div id="center" className="flex flex-col items-center justify-center p-2 mt-6 rounded noto-serif-kr">
                    <div id="centerText" className="flex justify-center flex-shrink-0 w-6/12 p-2 transition-colors">
    ...
    switch(type) {
        ...
        case "center":
            return (
                ...
                <div id="center" className="flex flex-col items-center justify-center p-2 rounded noto-serif-kr">
                    <div id="centerText" className="flex justify-center flex-shrink-0 w-6/12 p-2 transition-colors">
