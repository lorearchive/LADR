export default function DropdownLang() {
    return (
        ...
        <>
            <button id="dropdownDelayButton" data-dropdown-toggle="dropdownDelay" data-dropdown-delay="100" data-dropdown-trigger="hover" className="text-white focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center" type="button">
            ...
            <div id="dropdownDelay" className="z-10 hidden w-40 bg-white divide-y divide-gray-100 shadow dark:bg-gray-700">
