                ...
                <div id="settingsWindow" className="p-3">
                    <div id="setting" className="flex items-center">
                        ...
                        <div className="inline-flex ml-3 rounded-md shadow-xs dark:border-slate-700" role="group">
                            ...
                            <button type="button" onClick={() => handleNavigate("ko")} className={`px-4 py-2 border-t-3 border-b-3 text-sm dark:border-gray-700 rounded-e-lg font-medium focus:z-10 ${lang === "ko" ? "bg-blue-700 text-white dark:bg-blue-600" : "bg-white text-gray-900 hover:bg-gray-100 hover:text-blue-700 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700"}`}>
                                Korean (ko)
                            </button>
                        </div>
                    </div>
