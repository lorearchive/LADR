...
I am going to re-write LADR into [Svelte](https://svelte.dev/), currently it is written with React. Until that happens, which is the near future, contributing to the code is pointless. Although you can make suggestions in the Issue Tracker.
