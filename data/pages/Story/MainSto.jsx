...
export default function MainSto() {
    return (
        <>
            <h1 className="mb-5">Main Story</h1>
                ...
                <div href="#" className="flex flex-row mb-10 bg-white border border-gray-200 rounded-lg shadow dark:border-gray-700 dark:bg-gray-800">
                    <div className="flex flex-col justify-between p-4 pl-6 leading-normal">
                        <hgroup class="flex flex-row items-center">
                            <h5 className="mb-2 mr-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Prologue</h5>
                            <p className="font-normal text-gray-700 dark:text-gray-400"><em>Prologue yeah</em></p>
                        </hgroup>
